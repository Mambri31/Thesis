...
% Using a tolerance
function [Kt,Bt]=variable_impedanceTOL(qh,qk,rangeK,rangeB,t,cycle_duration)
    ...
    for l=1:n_phase-1
        ...
        best=signalTOL_analyzer(matrix_qh,matrix_qk,rangeK,rangeB,[-3 3],t_phase,cycle_duration);
