...
function [Kt,Bt]=variable_impedanceMAE(qh,qk,rangeK,rangeB,t,cycle_duration)
    ...
    for l=1:n_phase-1
        ...
        best=signalMAE_analyzer(matrix_qh,matrix_qk,rangeK,rangeB,t_phase,cycle_duration);
