...
K_B=load('K_B.mat') ;% Load the best costant gain combination
...
gain_swing=timeseries([zeros(600,1)',ones(400,1)'],t);
gain_stance=timeseries([ones(600,1)',zeros(400,1)'],t);
%% Define (K,B) for simulink simulations

Kt=timeseries(Kt.Kt,t);
Bt=timeseries(Bt.Bt,t);

Khip=K_B.K_B.K;Bhip=K_B.K_B.B;Kknee=K_B.K_B.K;Bknee=K_B.K_B.B;
